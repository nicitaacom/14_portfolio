...
export const ProjectClicksOverviewBarItem = memo(function ProjectClicksOverviewBarItem({
  ...
  const linkTypes = [
    { color: "bg-[#5a5a5a]", label: "Demo", value: item.demo_clicks },
    { color: "bg-[#5a5a5a]", label: "GitHub", value: item.github_clicks },
    { color: "bg-[#5a5a5a]", label: "Figma", value: item.figma_clicks },
    { color: "bg-[#5a5a5a]", label: "YouTube", value: item.youtube_clicks },
  ]
    ...
    <div
      ...
      <div className="flex items-center gap-sm">
        ...
        <div className="min-w-0 w-[160px]">
          ...
          <p className="text-xs uppercase tracking-[0.18em] text-secondary-foreground">{item.project_group}</p>
        </div>
