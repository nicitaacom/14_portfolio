function SummarySkeletonCard() {
  return (
    <div className="rounded-[2px] border border-brass/40 bg-steel px-sm py-sm">
      ...
      <div className="mt-sm h-[24px] w-[132px] animate-pulse rounded bg-steel" />
      <div className="mt-sm h-[10px] w-[110px] animate-pulse rounded bg-steel" />
    </div>
  )
}
  ...
  return (
    <div className="flex min-w-0 flex-col gap-sm">
        ...
        <div className="grid grid-cols-3 gap-xs">
          {Array.from({ length: 3 }).map((_, index) => (
            <div className="rounded-[2px] border border-brass/40 bg-steel px-sm py-sm" key={index}>
              ...
              <div className="mt-sm h-[16px] w-[42px] animate-pulse rounded bg-steel" />
              <div className="mt-sm h-[9px] w-[32px] animate-pulse rounded bg-steel" />
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="overflow-x-auto pb-xs">
        <div className="flex min-w-[920px] flex-col gap-md rounded-[2px] border border-brass/40 bg-steel px-sm py-sm">
          {[1, 2, 3].map(item => (
      ...
      <div className="grid gap-xs tablet:grid-cols-3">
        {Array.from({ length: 3 }).map((_, index) => (
          <div className="rounded-[2px] border border-brass/40 bg-steel px-sm py-sm" key={index}>
            ...
            <div className="mt-sm h-[20px] w-[52px] animate-pulse rounded bg-steel" />
          </div>
        ))}
      </div>
            ...
            <div className="rounded-[2px] border border-brass/40 bg-steel px-sm py-sm" key={index}>
              <div className="flex items-center gap-sm">
                ...
                <div className="w-[160px]">
                  ...
                  <div className="mt-sm h-[10px] w-[52px] animate-pulse rounded bg-steel" />
                </div>
              ...
              <div className="mt-sm flex flex-wrap gap-sm pl-lg">
