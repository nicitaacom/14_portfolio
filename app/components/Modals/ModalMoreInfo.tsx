...
export function ModalMoreInfo({
  ...
  return (
    <ModalContainer
      className="flex max-h-[calc(100dvh-1rem)] max-w-[calc(100vw-1rem)] flex-col tablet:max-h-[90vh] tablet:max-w-[900px] laptop:max-w-[1180px] desktop:max-w-[1280px]"
      isOpen={isOpen}
      onClose={onClose}
      title={badge ?? label}>
      <div className="flex min-h-0 flex-col overflow-hidden">
        ...
        <main className="modal-scroll hide-scrollbar flex-1 overflow-y-auto px-sm pb-sm pt-0 tablet:px-md tablet:pb-md tablet:pt-0">
          <div className="grid items-start gap-sm laptop:grid-cols-[380px_minmax(0,1fr)]">
            ...
            <section className="min-w-0 overflow-hidden rounded-[3px] border border-brass/60 bg-[linear-gradient(to_bottom,hsl(var(--steel-deep)/0.74),hsl(var(--wood)/0.35))] shadow-[inset_0_3px_6px_rgb(0_0_0/0.5),inset_0_1px_0_rgb(255_255_255/0.06),0_2px_3px_rgb(0_0_0/0.3)]">
              <div className="flex min-h-[60px] items-center border-b border-brass/40 bg-[linear-gradient(to_bottom,hsl(var(--paper)/0.06),transparent)] px-md py-sm">
                <div>
        ...
        <footer className="flex shrink-0 flex-col items-end gap-y-sm border-t border-brass/60 bg-[linear-gradient(to_bottom,hsl(var(--steel-deep)/0.3),hsl(var(--wood)/0.55))] px-md py-sm shadow-[inset_0_1px_0_rgb(255_255_255/0.1)] tablet:flex-row tablet:items-center tablet:justify-between">
          ...
          <div className="flex items-center gap-x-sm">
            <Button
              className="!border-brass/80 !bg-[repeating-linear-gradient(2deg,hsl(var(--steel-deep)/0.24)_0_1px,transparent_1px_6px),linear-gradient(to_bottom,hsl(var(--brass)/0.42),hsl(var(--wood)/0.97))] px-sm py-xs text-xs !shadow-[0_3px_0_hsl(var(--steel-deep)),0_7px_10px_rgb(0_0_0/0.5),inset_0_1px_0_rgb(255_255_255/0.18)]"
              onClick={() => window.open("https://discord.com/users/780002958380498955")}>
              {commonT("discord")} <RiDiscordLine size={18} />
            </Button>
            <Button className="!border-brass/80 !bg-[repeating-linear-gradient(2deg,hsl(var(--steel-deep)/0.24)_0_1px,transparent_1px_6px),linear-gradient(to_bottom,hsl(var(--brass)/0.42),hsl(var(--wood)/0.97))] px-sm py-xs text-xs !shadow-[0_3px_0_hsl(var(--steel-deep)),0_7px_10px_rgb(0_0_0/0.5),inset_0_1px_0_rgb(255_255_255/0.18)]" onClick={() => window.open("https://t.me/nicitaacom")}>
